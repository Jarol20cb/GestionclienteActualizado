...
@Component({
  selector: 'app-registro-perfiles',
  templateUrl: './registro-perfiles.component.html',
  styleUrls: ['./registro-perfiles.component.css']
})
export class RegistroPerfilesComponent implements OnInit{
